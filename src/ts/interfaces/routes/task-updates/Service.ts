...
export interface ITaskUpdatesService extends IService<ITaskUpdate> {
  ...
  createTaskUpdateFromTask: (task: ITask, userIdThatUpdated: any) => Promise<ITaskUpdate>
  createTaskUpdates: (oldTask: ITask, newTask: Partial<ITask>, userIdThatUpdated: string) => Promise<ITaskUpdate | undefined>
}
